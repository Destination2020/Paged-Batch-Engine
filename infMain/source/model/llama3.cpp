...
void LLama2Layers::materialize(std::shared_ptr<base::DeviceContext> context) {
  if (add_layer_) {
...
void LLama2Layers::to_cuda(std::shared_ptr<base::DeviceContext> context) {
...
void LLama2Model::init_mem() {
  ...
  if (device_type_ == base::DeviceType::kDeviceCUDA) {
    CHECK_NE(cuda_config_, nullptr);
    llama_layers_->materialize(device_context_);
  }
